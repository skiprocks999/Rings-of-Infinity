package com.contInf.ringsOfInfinity.client.renderer;
...
public class DemonicWardingBeaconTileEntityRenderer extends TileEntityRenderer<DemonicWardingBeaconTileEntity>{

	public static final ResourceLocation TEXTURE_BEACON_BEAM = new ResourceLocation("textures/entity/beacon_beam.png");
	private static final Logger logger = LogManager.getLogger(RingsOfInfinity.modID);
	
	public DemonicWardingBeaconTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
		//logger.debug("initializing rendering of warding beacon beacon beam");
	}

	@Override
	public void render(DemonicWardingBeaconTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
	 ...
	 public static void renderBeamSegment(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, ResourceLocation textureLocation, float partialTicks, float textureScale, long totalWorldTime, int yOffset, int height, float[] colors, float beamRadius, float glowRadius) {
	   ...
	   public boolean isGlobalRenderer(DemonicWardingBeaconTileEntity te) {
	      return true;
	   }
}
