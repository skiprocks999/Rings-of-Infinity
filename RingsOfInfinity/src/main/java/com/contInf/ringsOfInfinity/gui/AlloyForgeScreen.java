...
public class AlloyForgeScreen extends ContainerScreen<AlloyForgeContainer>{
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack,float partialTicks, int mouseX, int mouseY) {
		...
		AlloyForgeScreen.blit(matrixStack,this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize,256,256);
		...
		this.blit(matrixStack,this.guiLeft + 9, this.guiTop + 39 + yOffset, 176, yOffset, 14, (14 - yOffset));

		
		//Progress Bar
		this.blit(matrixStack,this.guiLeft + 66, this.guiTop + 14, 176, 15, 
