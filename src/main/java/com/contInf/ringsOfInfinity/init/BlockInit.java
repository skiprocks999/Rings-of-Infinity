...
public class BlockInit {
	...
	public static final DeferredRegister<Block> BLOCKS = 
			DeferredRegister.create(ForgeRegistries.BLOCKS , RingsOfInfinity.modID);
	...
	public static final RegistryObject<Block> cobra_stone = 
			...
			hardnessAndResistance(2.0f, 3.0f).sound(SoundType.GLASS).setLightLevel((lightlevel) -> 15)));
	//cobra stone lamp
	...
	//some sort of wood block maker
	public static final RegistryObject<Block> aboral_engenderer =
			BLOCKS.register("aboral_engenderer", () -> new Block(Block.Properties.create(Material.IRON).
					hardnessAndResistance(2.0f, 3.0f).sound(SoundType.STONE)));
	//some sort of mob drop maker
	public static final RegistryObject<Block> ethereal_corruptor =
			BLOCKS.register("ethereal_corruptor", () -> new Block(Block.Properties.create(Material.IRON).
					hardnessAndResistance(2.0f, 3.0f).sound(SoundType.STONE)));
	//some sort of block converter
	public static final RegistryObject<Block> tectonic_recrystalizer = 
			BLOCKS.register("tectonic_recrystalizer", () -> new Block(Block.Properties.create(Material.IRON).
					hardnessAndResistance(2.0f, 3.0f).sound(SoundType.STONE)));
